                ...
                <div class="col-lg-6">
                    ...
                    <form onSubmit = "return checkPassword(this)">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="email" required id="email" class="form-control" placeholder="Nhập email">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" required id="name" class="form-control" placeholder="Nhập họ và tên">
                        <div class="form-notch"><div class="form-notch-leading" style="width: 9px;"></div><div class="form-notch-middle" style="width: 64.8px;"></div><div class="form-notch-trailing"></div></div></div>

                        <div class="form-outline mb-4">
                            <label class="form-label" for="password" style="margin-left: 0px;">Mật khẩu</label>
                            <input type="password" required id="password" class="form-control" placeholder="Nhập mật khẩu">
                        <div class="form-notch"><div class="form-notch-leading" style="width: 9px;"></div><div class="form-notch-middle" style="width: 66.4px;"></div><div class="form-notch-trailing"></div></div></div>

                        <div class="form-outline mb-4">
                            <label class="form-label" for="repassword" style="margin-left: 0px;">Xác nhận mật khẩu</label>
                            <input type="password" required id="repassword" class="form-control" placeholder="Nhập lại mật khẩu">
                        <div class="form-notch"><div class="form-notch-leading" style="width: 9px;"></div><div class="form-notch-middle" style="width: 64.8px;"></div><div class="form-notch-trailing"></div></div></div>

                        <div class="text-center pt-1 mb-5 pb-1">
                        <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3 btn-submit" type="submit">Đăng ký</button>
                        </div>
